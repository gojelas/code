...
SPO_sim=simulate(SPOMale_mean,nsim = 5000,h=80,gc.order = c(4,0,4))
...
matplot(SPOMale_mean$years, t(qxt[c(m_min[i]=mean_-1.96*stdr/sqrt(500) "85"), ]),
